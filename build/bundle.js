...
const TAKES = [
  {
    ...
    transcription: "En el 2024, Warren Buffett logr\xF3 un 22%.",
    images: ["Images/warren_buffet.jpg"],
    enableZoom: false,
    audioStartFrom: 1.2,
    // Skip first 1.20 seconds
    videoStartFrom: 1.2
    // Skip first 1.20 seconds
  },
  {
    ...
    transcription: "siendo uno de los inversores m\xE1s importantes del planeta y teniendo todo un equipo de egresados de Harvard trabajando para \xE9l.",
  ...
  },
  {
    ...
    transcription: "\xC9l solo logr\xF3 un 22%. \xBFPero sabes qui\xE9n logr\xF3 35%?",
    images: ["Images/warren_buffet_3.webp", "Images/google.png"],
    enableZoom: false
  },
  {
    id: 4,
    ...
    transcription: "el Congreso de Estados Unidos. Personas que en su mayor\xEDa tienen de sesenta a ochenta a\xF1os, compran acciones desde su tel\xE9fono y no tienen ni idea ni un equipo detr\xE1s de analistas, como lo tendr\xEDa Warren Buffett.",
    images: ["Images/capitolio.jpg"],
    enableZoom: true
    // Longer take needs zoom
  },
  {
    id: 5,
    videoPath: "Video/toma_5.MOV",
    audioPath: "Audio/toma_5.m4a",
    transcription: "Nancy Pelosi logr\xF3 un 103% con Google. Marjorie Taylor Greene logr\xF3 un 117% con AMD, resultados que Warren Buffett solo podr\xEDa haber so\xF1ado.",
    images: [
  ...
  },
  {
    ...
    transcription: "Inversores como Warren Buffett tienen que enfrentarse a la incertidumbre del mercado. Los pol\xEDticos ya saben qu\xE9 va a pasar, y por eso nosotros seguimos a los pol\xEDticos.",
  ...
  },
  {
    ...
    transcription: "\xBFSi quieres saber c\xF3mo lo hacemos? S\xEDguenos!",
...
const IMAGE_KEYWORDS = {
  ...
  "Images/cash_piles.jpg": ["quieres saber", "c\xF3mo lo hacemos"]
};
...
const ImageOverlay = ({
  ...
  const opacity = (0,esm.interpolate)(
    frame - startFrame,
    [0, actualFadeIn, Math.max(actualFadeIn, totalDuration - actualFadeOut), totalDuration],
    [0, 0.85, 0.85, 0],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
...
function generateSubtitlesFromTimestamps(words, fps) {
...
function groupSubtitlesFromTimestamps(subtitles, maxWordsPerChunk = 3, maxGapSeconds = 0.3, fps = 30) {
  ...
  for (let i = 0; i < subtitles.length; i++) {
    ...
    const shouldStartNew = currentChunk.length >= maxWordsPerChunk || prevWord && word.startFrame - prevWord.endFrame > maxGapSeconds * fps;
...
function generateSubtitles(transcription, durationInFrames, fps) {
...
function groupSubtitlesIntoChunks(subtitles, wordsPerChunk = 2) {
  const chunks = [];
...
;// ./src/utils/videoTiming.ts


function detectImageOverlays(transcription, durationInFrames, availableImages) {
  const overlays = [];
  ...
  availableImages.forEach((imagePath) => {
    ...
    keywords.forEach((keyword) => {
      ...
      if (position !== -1) {
        const wordsBeforeKeyword = transcription.substring(0, position).split(" ").length;
  ...
  const uniqueOverlays = overlays.filter(
    (overlay, index, self) => index === self.findIndex((o) => o.imagePath === overlay.imagePath)
  );
  return uniqueOverlays;
}

;// ./src/config/timestamps.json
6.54,"end":6.72},{"word":"saben","start":6.72,"end":7.08},{"word":"que","start":7.08,"end":7.3},{"word":"va","start":7.3,"end":7.42},{"word":"a","start":7.42,"end":7.44},{"word":"pasar","start":7.44,"end":7.88},{"word":"y","start":7.88,"end":8.44},{"word":"por","start":8.44,"end":8.64},{"word":"eso","start":8.64,"end":8.82},{"word":"nosotros","start":8.82,"end":9.18},{"word":"seguimos","start":9.18,"end":9.72},{"word":"a","start":9.72,"end":9.9},{"word":"los","start":9.9,"end":10.06},{"word":"políticos.","start":10.06,"end":11}]},"toma_7":{"take":7,"duration":4.54,"text":"si quieres saber cómo lo hacemos, síguenos","words":[{"word":"si","start":0,"end":0.68},{"word":"quieres","start":0.68,"end":0.98},{"word":"saber","start":0.98,"end":1.42},{"word":"cómo","start":1.42,"end":2.02},{"word":"lo","start":2.02,"end":2.22},{"word":"hacemos,","start":2.22,"end":2.74},{"word":"síguenos","start":3.38,"end":4.54}]}}');
;// ./src/components/VideoTake.tsx
...
const VideoTake = ({ take, durationInFrames }) => {
  const { fps } = (0,esm.useVideoConfig)();
  const takeKey = `toma_${take.id}`;
  const timestampData = timestamps_namespaceObject[takeKey];
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    take.enableZoom ? /* @__PURE__ */ (0,jsx_runtime.jsx)(ZoomEffect, { durationInFrames, enabled: take.enableZoom, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.AbsoluteFill,
      {
        style: {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.OffthreadVideo,
          {
            src: (0,esm.staticFile)(take.videoPath),
            muted: true,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Audio,
      {
        src: (0,esm.staticFile)(take.audioPath),
        startFrom: take.audioStartFrom ? Math.floor(take.audioStartFrom * fps) : 0
      }
    ),
    subtitleChunks.map((chunk, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        from: chunk.startFrame,
        durationInFrames: chunk.endFrame - chunk.startFrame,
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Subtitle, { text: chunk.text })
      },
      index
    )),
    imageOverlays.map((overlay, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ImageOverlay,
      {
...
const TransitionEffect = ({
  ...
  const frame = (0,esm.useCurrentFrame)();
  const fadeIn = (0,esm.interpolate)(
    frame,
...
const TAKE_DURATIONS = [
  timestamps_namespaceObject.toma_1.duration,
  // 6.0s (1.20s offset)
  timestamps_namespaceObject.toma_2.duration,
  // 8.78s
  timestamps_namespaceObject.toma_3.duration,
  // 8.9s (+0.5s extended)
  timestamps_namespaceObject.toma_4.duration,
  // 17.06s
  timestamps_namespaceObject.toma_5.duration,
  // 17.8s
  timestamps_namespaceObject.toma_6.duration,
  // 11.0s (+0.3s extended)
  timestamps_namespaceObject.toma_7.duration
  // 4.54s (+0.3s extended)
];
const FPS = 30;
const MyComposition = () => {
  let currentFrame = 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#000" }, children: TAKES.map((take, index) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        from,
        durationInFrames,
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionEffect, { durationInFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(VideoTake, { take, durationInFrames }) })
      },
      take.id
    );
  }) });
...
const fps = 30;
const totalSeconds = timestamps_namespaceObject.toma_1.duration + timestamps_namespaceObject.toma_2.duration + timestamps_namespaceObject.toma_3.duration + timestamps_namespaceObject.toma_4.duration + timestamps_namespaceObject.toma_5.duration + timestamps_namespaceObject.toma_6.duration + timestamps_namespaceObject.toma_7.duration;
